...
<html lang="en">
        	...
        	$(document).ready(function() {
        		...
        		$('table .edit').on('click', function() {
        			...
        			success: function(result) {
        				...
        				$('#editEmployeeModal #price').val(result.price);
        				$('#editEmployeeModal #title').val(result.title);
        				$('#editEmployeeModal #description').val(result.description);
        				$('#editEmployeeModal #category').val(result.category);
        			}
        		})
        	});
        </script>
    <body>
                    ...
                    <tbody>
                        <c:forEach items="${listprd }" var="o">
                            <tr>
                                ...
                                <td>${o.price } $</td>
                                <td>
                                    <a href="#editEmployeeModal"  class="edit" data-toggle="modal" data-toggle="tooltip" title="edit"><i class="material-icons" title="Edit">&#xE254;</i></a>
                                    
                                    <a href="#deleteEmployeeModal" class="delete" data-toggle="modal" data-toggle="tooltip" title="delete"><i class="material-icons" title="Delete">&#xE872;</i></a>
        ...
        <div id="addEmployeeModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="managerProduct?action=create" method="post">
        ...
        <div id="editEmployeeModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="managerProduct?action=update" method="post">
                        <div class="modal-header">						
